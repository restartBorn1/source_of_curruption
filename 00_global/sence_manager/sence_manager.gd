...
signal new_scence_ready(target_name:String,offset:Vector2)
...
func level_transition(new_scene:String,target_area:String,player_offset:Vector2,dir:String) -> void:
	...
	new_scence_ready.emit(target_area,player_offset)
	# fade new scene in
